...
function initFades() {
  ...
  if (currentURL.indexOf("#") > -1)
    ...
    DoFade(
      StartFadeAt,
      currentURL.substring(currentURL.indexOf("#") + 1, currentURL.length)
    )
...
function DoFade(colorId, targetId) {
  ...
  // If an input,
  if (
    document.getElementById(targetId).nodeName == "INPUT" ||
    document.getElementById(targetId).nodeName == "SELECT"
  ) {
