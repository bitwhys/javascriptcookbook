...
;(function(undefined) {
  ...
  var main = function() {
    ...
    var $iterator$ =
      (typeof Symbol === "object" && Symbol.iterator) || "_es6shim_iterator_"
    ...
    var ES = {
      ...
      IsIterable: function(o) {
        return (
          ES.TypeIsObject(o) && (o[$iterator$] !== undefined || isArguments(o))
        )
      },
    ...
    defineProperties(Array, {
      from: function(iterable) {
        ...
        var result = ES.IsCallable(this)
          ? Object(usingIterator ? new this() : new this(length))
          : new Array(length)
    ...
    if (
      !supportsSubclassing(globals.Promise, function(S) {
