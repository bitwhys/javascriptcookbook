    ...
    newLang: function() {
      $.validationEngineLanguage.allRules = {
        ...
        CZphone: {
          ...
          alertText:
            "* Neplatné telefoní číslo, zadejte ve formátu +420 598-598-895",
        },
        phone: {
        ...
        CZdate: {
          ...
          alertText:
            "* Neplatné datum, datum musí být ve formátu den.měsíc.rok (dd.mm.rrrr)",
        },
        date: {
        ...
        psc: {
          regex: /^\d{3}[ \.\-]\d{2}$/,
          alertText:
            "* Neplatné poštovní směrovací číslo, tvar musí být 456 45",
        },
        url: {
