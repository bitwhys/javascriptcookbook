...
;(function() {
  ...
  B = "meta alt option ctrl shift cmd".split(" ")
  m = "ctrl"
  o = { debug: !1 }
  var D = function(a) {
    var c, b
    for (c in a) C.call(a, c) && ((b = a[c]), !1 !== b && (this[c] = b))
    this.keys = this.keys || []
    this.count = this.count || 0
  }
  D.prototype.allows_key_repeat = function() {
  ...
  var g = function(a, c) {
    ...
    this._defaults = c || {}
    for (b in q)
      C.call(q, b) && ((d = q[b]), (this._defaults[b] = this._defaults[b] || d))
    a = a || document.body
    b = function(a, b, c) {
    ...
    b(window, "blur", function() {
      ...
      d = h._keys_down
      b = 0
      for (c = d.length; b < c; b++) (a = d[b]), h._key_up(a, {})
      return (h._keys_down = [])
    })
  }
  ...
  g.prototype._receive_input = function(a, c) {
    ...
    if (this._prevent_capture) this._keys_down.length && (this._keys_down = [])
      ...
      ((b = y(a.keyCode)),
      (c || this._keys_down.length || !("alt" === b || b === m)) && b)
    )
  ...
  g.prototype._match_combo_arrays = function(a, c) {
    ...
    for (e = f.length; d < e; d++)
      (b = f[d]),
        ((!b.is_unordered && x(a, b.keys)) ||
          (b.is_unordered && v(a, b.keys))) &&
          c(b)
  }
  ...
  g.prototype._handle_combo_up = function(a, c, b) {
    ...
    if (
      !a.keyup_fired &&
      ((d = this._keys_down.slice()), d.push(b), !a.is_solitary || v(d, a.keys))
    )
  ...
  g.prototype.register_combo = function(a) {
    ...
    d = this._defaults
    for (c in d) C.call(d, c) && ((b = d[c]), void 0 === a[c] && (a[c] = b))
    a = new D(a)
  ...
  g.prototype.unregister_combo = function(a) {
    ...
    for (e = f.length; d < e; d++)
      (c = f[d]),
        null != c &&
          ((c.is_unordered && v(a, c.keys)) || (!c.is_unordered && x(a, c.keys))
            ? g.push(b(c))
            : g.push(void 0))
    return g
  }
  ...
  I = function(a) {
    ...
    if (0 <= j.call(a.keys, "meta") || 0 <= j.call(a.keys, "cmd")) {
      c = a.keys.slice()
      g = 0
      for (i = B.length; g < i; g++)
        (d = B[g]), -1 < (b = A.call(c, d)) && c.splice(b, 1)
      1 < c.length &&
        (p(
